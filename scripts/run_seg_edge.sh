#!/bin/bash
cd ..
python main.py --output_dir ./results/unetatt_edge_3_50p/ --image_size 256 --train_batch_size 8 --num_train_epochs 200 \
--model attention_unet \
--aug_train_frames "./data/generated-frames-edge-1-1-140000-cmmd/" \
