#!/bin/bash
cd ..
python main.py --output_dir ./results/unetatt_nm_3_50p/ --image_size 256 --train_batch_size 8 --num_train_epochs 200 \
--model attention_unet \
--aug_train_frames "./data/generated-frames-nm-2-1-120000-cmmd/" \
